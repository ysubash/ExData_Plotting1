...
par(mfcol=c(2,2))
plot(sub.data$DateTime,sub.data$Global_active_power,type = "l",ylab="Global Active Power",xlab="")
...
legend("topright",lty=1, col=c('black', 'red', 'blue'),bty="n",cex=.75,c("Sub_metering_1","Sub_metering_2","Sub_metering_3"))
plot(sub.data$DateTime,sub.data$Voltage,type = "l",ylab = "Voltage",xlab="")
plot(sub.data$DateTime,sub.data$Global_reactive_power,type = "l",xlab="",ylab="Global_reactive_power")
dev.off()